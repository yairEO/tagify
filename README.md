...
dropdown.*overflowToLeft*            | <sub>Boolean</sub>            | false                                     | Expend dropdown to left, by default expend to left<br>Mainly relevant for RTL languages<br>Must assign true to withAuto property

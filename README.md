...
label                          | <sub>String</sub>            |                                             | Accessible label text for the internal editable input. When set, Tagify will apply it as `aria-label` to the contenteditable element. Useful to meet accessibility requirements when using a non-native input.

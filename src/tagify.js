...
Tagify.prototype = {
  ...
  input: {
    ...
    validate() {
      var isValid =
        ...
        this.validateTag({ value: this.state.inputText }) === true;
    ...
    var { whitelist, delimiters, mode, tagTextProp } = this.settings,
      ...
      mapStringToCollection = (s) =>
        (s + '')
          .split(delimiters)
          .filter((n) => n)
          .map((v) => ({ [tagTextProp]: this.trim(v), value: this.trim(v) }));
  ...
  removeTags(tagElms, silent, tranDuration) {
    ...
    return _s.hooks
      .beforeRemoveTag(tagsToRemove, { tagify: this })
      .then(() => {

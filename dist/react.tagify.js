...
const TagifyWrapper = ({
  ...
  const inputAttrs = (0, _react.useMemo)(() => ({
    ref: handleRef,
    name,
    defaultValue: children ? children : typeof value === "string" ? value : JSON.stringify(value),
    className,
    readOnly,
    autoFocus,
    placeholder
  ...
  (0, _react.useEffect)(() => {
    ...
    t.on("dropdown:updated", onDropdownUpdated); // Bridge Tagify instance with parent component

/**
 * Tagify (v 3.17.0)- tags input component
 * By Yair Even-Or
...
var TagifyWrapper = function TagifyWrapper(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var tagify = tagify.current = new _tagifyMin["default"](inputElmRef.current, settings);
    ...
    onClick && tagify.on("click", onClick); // Bridge Tagify instance with parent component

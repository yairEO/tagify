  ...
  events: {
    ...
    callbacks: {
            ...
            case 'Backspace':
              {
                ...
                setTimeout(function () {
                  ...
                  var tagElms = _this4.getTagElms(); // find out which tag(s) were deleted and update "this.value" accordingly
                  ...
                  for (var id in _this4.tagsDataById) {
                    if (!ids.includes(id)) delete _this4.tagsDataById[id];
                  }
      ...
      onMixTagsInput: function onMixTagsInput(e) {
        ...
        console.log(this.tagsDataById); // check if any tags were magically added through browser redo/undo

        if (tagsCount > lastTagsCount) {
          var value = [].map.call(this.getTagElms(), function (node) {
            return node.__tagifyId;
          });
          console.log(value); //  console.log( this.getMixedTagsAsString(value)  )
  ...
  parseMixTags: function parseMixTags(s) {
    ...
    s = s.split(mixTagsInterpolator[0]).map(function (s1, i) {
      ...
      if (s2.length > 1 && (!enforceWhitelist || _this10.isTagWhitelisted(tagData.value)) && !(!duplicates && _this10.isTagDuplicate(tagData))) {
        ...
        _this10.tagsDataById[id] = tagData;

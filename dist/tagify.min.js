...
(function (global, factory) {
  ...
  var events = {
    ...
    callbacks: {
      ...
      onKeydown(e) {
        ...
        switch (e.key) {
          case 'Backspace':
            if (this.settings.mode == 'select' && this.settings.enforceWhitelist) this.removeTags();else if (!this.state.dropdown.visible || this.settings.dropdown.position == 'manual') {
  ...
  Tagify.prototype = {
    ...
    selectTag(tagElm, tagData) {
      ...
      this.input.set.call(this, tagData[_s.tagTextProp || 'value'], true); // place the caret at the end of the input, only if a dropdown option was selected (and not by manually typing another value and clicking "TAB")

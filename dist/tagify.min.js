...
(function (global, factory) {
  ...
  var events = {
    ...
    binding: function binding() {
      ...
      if (this.settings.mode == 'mix') observeDOM(this.DOM.input, function (m) {
        var lastChild = that.DOM.input.lastChild; // for some reason a weird empty textNode is being added (delete all content in mix mode & add a tag)

        if (lastChild && lastChild.nodeType == 3 && !lastChild.wholeText) lastChild.parentNode.removeChild(lastChild);

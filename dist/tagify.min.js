  ...
  var events = {
    ...
    callbacks: {
      ...
      onEditTagBlur: function onEditTagBlur(editableElm) {
        ...
        } else // check if the new value is in the whiteilst, if not check if there
  ...
  Tagify.prototype = {
    ...
    normalizeTags: function normalizeTags(tagsItems) {
      ...
      var _this$settings = this.settings,
        ...
        return (s + "").split(delimiters).filter(function (n) {
          ...
          return _defineProperty({}, tagTextProp, _this7.trim(v));
        });
      };
      ...
      if (whitelistWithProps) {
        tagsItems.forEach(function (item) {
          ...
          var matchObj = _this7.getWhitelistItem(item[tagTextProp]);
    ...
    parseMixTags: function parseMixTags(s) {
      ...
      s = s.split(mixTagsInterpolator[0]).map(function (s1, i) {
        ...
        if (!maxTagsReached && s2.length > 1 && (!enforceWhitelist || _this8.isTagWhitelisted(tagData.value)) && !(!duplicates && _this8.isTagDuplicate(tagData.value))) {
    ...
    addTags: function addTags(tagsItems, clearInput) {
      ...
      tagsItems.forEach(function (tagData) {
        ...
        if (tagData.__isValid !== true) {
          ...
          extend(tagElmParams, _this9.getInvalidTagAttrs(tagData, tagData.__isValid), {
            __preInvalidData: originalData
          });
          if (tagData.__isValid == _this9.TEXTS.duplicate) // mark, for a brief moment, the tag (this this one) which THIS CURRENT tag is a duplcate of
            _this9.flashTag(_this9.getTagElmByValue(tagData.value));
        } /////////////////////////////////////////////////////
    ...
    addMixTags: function addMixTags(tagsItems) {
      ...
      !createdFromDelimiters && setTimeout(function () {
        var elm = _this10.insertAfterTag(tagElm) || tagElm;

        _this10.placeCaretAfterNode(elm);

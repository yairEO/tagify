    ...
    callbacks: {
      ...
      onMixTagsInput: function onMixTagsInput(e) {
        ...
        this.value.slice().forEach(function (item) {
          ...
          if (item.readonly && !remainingTagsValues.includes(item.value)) _this4.injectAtCaret(_this4.createTagElem(item), window.getSelection().getRangeAt(0));
  ...
  Tagify.prototype = {
    ...
    parseMixTags: function parseMixTags(s) {
      ...
      s = s.split(mixTagsInterpolator[0]).map(function (s1, i) {
        ...
        if (!maxTagsReached && s2.length > 1 && (!enforceWhitelist || _this9.isTagWhitelisted(tagData.value)) && !(!duplicates && _this9.isTagDuplicate(tagData.value))) {

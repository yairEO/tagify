(function (global, factory) {
  ...
  var dropdownMethods = {
    ...
    selectOption: function selectOption(elm) {
      ...
      if (!tagifySuggestionIdx || !tagData) return;
      ...
      else this.addTags([tagData], clearOnSelect); // todo: consider not doing this on mix-mode
    ...
    createListHTML: function createListHTML(optionsArr) {
      ...
      return optionsArr.map(function (suggestion, idx) {
        ...
        tagHTMLString = tagHTMLString.replace('>', " tagifySuggestionIdx=\"".concat(idx, "\">"));
  ...
  var events = {
    ...
    callbacks: {
      ...
      onEditTagBlur: function onEditTagBlur(editableElm) {
        ...
        newTagData = this.getWhitelistItem(textValue) || (_ref = {}, _defineProperty(_ref, _s.tagTextProp, textValue), _defineProperty(_ref, "value", textValue), _ref);
    ...
    reCheckInvalidTags: function reCheckInvalidTags() {
      ...
      [].forEach.call(tagElms, function (node) {
        var tagData = _this10.tagData(node),
            ...
            isNodeValid = _this10.validateTag(tagData) === true; // if this tag node was marked as a dulpicate, unmark. (might have been marked as "notAllowed" for other reasons)

(function (global, factory) {
  ...
  const removeCollectionProp = (collection, unwantedProps) => collection && isArray(collection) && collection.map(v => omit(v, unwantedProps));
  ...
  var dropdownMethods = {
      ...
      callbacks: {
            ...
            case 'Enter':
              {
                ...
                this.settings.hooks.suggestionClick(e, {
                  ...
                  if (selectedElm) this.dropdown.selectOption.call(this, selectedElm);else this.dropdown.hide.call(this);
                }).catch(err => err);
                break;
              }
        ...
        onClick(e) {
          ...
          var selectedElm = e.target.closest(this.settings.classNames.dropdownItemSelector),
              selectedElmData = this.dropdown.getSuggestionDataByNode.call(this, selectedElm); // temporary set the "actions" state to indicate to the main "blur" event it shouldn't run
    ...
    selectOption(elm) {
      ...
      } else this.dropdown.refilter.call(this);
    },
    ...
    callbacks: {
      ...
      onMixTagsInput(e) {
        ...
        setTimeout(() => {
          ...
          if (this.state.tag) this.dropdown[showSuggestions ? "show" : "hide"].call(this, this.state.tag.value);
        }, 10);
      },
      ...
      onPaste(e) {
        ...
        this.settings.hooks.beforePaste(e, {
          ...
          if (result) {
            ...
            } else this.addTags(this.DOM.input.textContent, true);
          }
        }).catch(err => err);
      },
  ...
  Tagify.prototype = {
    ...
    getAttributes(data) {
      ...
      for (i = keys.length; i--;) {
        propName = keys[i];
        if (propName.slice(0, 2) != '__' && propName != 'class' && data.hasOwnProperty(propName) && data[propName] !== undefined) s += " " + propName + (data[propName] !== undefined ? `="${data[propName]}"` : "");
      }
    ...
    reCheckInvalidTags() {
      ...
      [].forEach.call(tagElms, node => {
        var tagData = this.tagData(node),
            ...
            isNodeValid = this.validateTag(tagData) === true; // if this tag node was marked as a dulpicate, unmark. (might have been marked as "notAllowed" for other reasons)
    ...
    update(args) {
      var inputElm = this.DOM.originalInput,
          _ref = args || {},
          withoutChangeEvent = _ref.withoutChangeEvent;

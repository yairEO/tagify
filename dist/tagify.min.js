  ...
  var events = {
    ...
    callbacks: {
      ...
      onPaste: function onPaste(e) {
        ...
        if (this.settings.mode == 'mix') this.injectAtCaret(pastedData, window.getSelection().getRangeAt(0));else this.addTags(pastedData); // this.input.set.call(this, pastedData)
      },

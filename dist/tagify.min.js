(function (global, factory) {
    ...
    callbacks: {
      ...
      onEditTagBlur: function onEditTagBlur(editableElm) {
        ...
        var _s = this.settings,
            ...
            newTagData = extend({}, originalData, _defineProperty({}, _s.tagTextProp, textValue)),
            hasChanged = tagElm.innerHTML != tagElm.__tagifyTagData.__originalHTML,
            isValid = this.validateTag(_defineProperty({}, _s.tagTextProp, textValue)); //  this.DOM.input.focus()
        ...
        if (hasChanged) {
          _s.transformTag.call(this, newTagData); // MUST re-validate after tag transformation
        ...
        if (isValid !== true) {
          ...
          newTagData = this.getWhitelistItem(textValue) || newTagData.__preInvalidData || newTagData; // again, check if the tag is not a duplicate, because at this point it might be if
          ...
          if (isValid !== true) {
            ...
            tagElm.classList.toggle(_s.classNames.tagInvalid, true); // do nothing if invalid, stay in edit-mode until corrected or reverted by presssing esc
  ...
  Tagify.prototype = {
     ...
     */
    getWhitelistItem: function getWhitelistItem(value, prop) {
      var result,
          prop = prop || 'value',
          _s = this.settings,
          _cs = _s.dropdown.caseSensitive;

      _s.whitelist.some(function (_wi) {
    ...
    normalizeTags: function normalizeTags(tagsItems) {
      ...
      var _this$settings = this.settings,
        ...
        return (s + "").split(delimiters).filter(function (n) {
          ...
          return _defineProperty({}, tagTextProp, _this6.trim(v));
        });
      };
      ...
      if (whitelistWithProps) {
        tagsItems.forEach(function (item) {
          ...
          var matchObj = _this6.suggestedListItems && _this6.suggestedListItems.length ? _this6.suggestedListItems[0] : _this6.getWhitelistItem(item[tagTextProp]);
    ...
    addMixTags: function addMixTags(tagsItems) {
      ...
      !createdFromDelimiters && setTimeout(function () {
        var elm = _this9.insertAfterTag(tagElm) || tagElm;

        _this9.placeCaretAfterNode(elm);

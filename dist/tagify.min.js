  ...
  Tagify.prototype = {
    ...
    isTagWhitelisted: function isTagWhitelisted(v) {
      ...
      return this.settings.whitelist.some(function (item) {
        return typeof v == 'string' ? sameStr(_this6.trim(v), item.value || item) : sameStr(JSON.stringify(item), JSON.stringify(v));
      });
    },
    ...
    parseMixTags: function parseMixTags(s) {
      ...
      s = s.split(mixTagsInterpolator[0]).map(function (s1, i) {
        ...
        if (s2.length > 1 && (!enforceWhitelist || _this8.isTagWhitelisted(tagData.value)) && !(!duplicates && _this8.isTagDuplicate(tagData.value))) {
          ...
          tagElm.classList.add(_this8.settings.classNames.tagNoAnimation);
    ...
    addTags: function addTags(tagsItems, clearInput) {
      ...
      tagsItems.forEach(function (tagData) {
        ...
        _s.transformTag.call(_this9, tagData);

        if (tagData.__isValid !== true) {
          if (skipInvalid) return;
          extend(tagElmParams, _this9.getInvalidTagParams(tagData, tagData.__isValid), {
    ...
    addMixTags: function addMixTags(tagsItems) {
      ...
      !createdFromDelimiters && setTimeout(function () {
        _this10.insertAfterTag(tagElm);

        _this10.placeCaretAfterTag(tagElm);

  ...
  Tagify.prototype = {
    ...
    getTagIndexByValue: function getTagIndexByValue(value) {
      ...
      this.getTagElms().forEach(function (tagElm, i) {
        if (sameStr(tagElm.textContent.trim(), value, _this4.settings.dropdown.caseSensitive)) indices.push(i);
      });
      return indices;
    },
    ...
    normalizeTags: function normalizeTags(tagsItems) {
      ...
      if (whitelistWithProps) {
        tagsItems.forEach(function (item) {
          ...
          var matchObj = _this6.getWhitelistItemsByValue(item.value)[0];
    ...
    parseMixTags: function parseMixTags(s) {
      ...
      s = s.split(mixTagsInterpolator[0]).map(function (s1, i) {
        ...
        if (s2.length > 1 && (!enforceWhitelist || _this7.isTagWhitelisted(tagData.value)) && !(!duplicates && _this7.isTagDuplicate(tagData.value))) {
    ...
    replaceTextWithNode: function replaceTextWithNode(wrapperElm, strToReplace) {
      ...
      nodeAtCaret.parentNode.insertBefore(wrapperElm, replacedNode); // must NOT normalize contenteditable or it will cause unwanetd issues:
    ...
    addTags: function addTags(tagsItems, clearInput) {
      ...
      tagsItems.forEach(function (tagData) {
        ...
        _s.transformTag.call(_this8, tagData); ///////////////// ( validation )//////////////////////
        ...
        if (tagData.__isValid !== true) {
          ...
          extend(tagElmParams, _this8.getInvalidTagParams(tagData, tagData.__isValid), {
            __preInvalidData: originalData
          }); // mark, for a brief moment, the tag THIS CURRENT tag is a duplcate of

          if (tagData.__isValid == _this8.TEXTS.duplicate) _this8.flashTag(_this8.getTagElmByValue(tagData.value));
        } /////////////////////////////////////////////////////
    ...
    addMixTags: function addMixTags(tagsItems) {
      ...
      setTimeout(function () {
        return tagElm.classList.add(_this9.settings.classNames.tagNoAnimation);
      }, 300);
      ...
      setTimeout(function () {
        ...
        _this9.placeCaretAfterTag(tagElm);
      }, 100);
      return tagElm;
    },
    ...
    removeTags: function removeTags(tagElms, silent, tranDuration) {
      ...
      tagsToRemove = tagElms.reduce(function (elms, tagElm) {
        ...
        if (tagElm) // because the DOM node might be removed by async animation, the state will be updated while
          ...
          elms.push({
            node: tagElm,
            idx: _this11.getTagIdx(_this11.tagData(tagElm)),
